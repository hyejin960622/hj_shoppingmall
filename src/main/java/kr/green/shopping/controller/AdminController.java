...
public class AdminController {
	...
	public ModelAndView productInsertPost(ModelAndView mv, ProductVO product, MultipartFile file,
		...
		messageService.message(response, "제품을 등록했습니다.", "/shopping/admin/product/list");
	...
	public ModelAndView productDeletePost(ModelAndView mv, HttpServletResponse response, String pr_code) {
		...
		if(res)
			messageService.message(response, "삭제되었습니다", "/shopping/admin/product/list");
		else
			messageService.message(response, "삭제하지 못했습니다.", "/shopping/admin/product/list");
		mv.setViewName("redirect:/admin/product/list");
		return mv;
	}
	...
	public ModelAndView noticeInsertPost(ModelAndView mv, BoardVO board, 
		...
		if(res)
			messageService.message(response, "등록완료", "/shopping/admin/notice/list");
		else
			messageService.message(response, "등록실패", "/shopping/admin/notice/insert");
		return mv;
	}
	...
	public ModelAndView noticeUpdatePost(ModelAndView mv, BoardVO board,
		...
		if(res)
			messageService.message(response, "수정완료", "/shopping/admin/notice/list");
		else
			messageService.message(response, "수정실패", "/shopping/admin/notice/list");
		return mv;
	}
